 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |KC_LCTL| CTRL | GUI  | Alt |Raise |Space |Space |Adjust| F10  |  F11 | F12  |PRSCRN|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, RAISE,   KC_SPC,  KC_SPC,  ADJUST,  KC_F10,  KC_F11,  KC_F12,  KC_PSCR \
),
 ...
 */
[_LOWER] = KEYMAP( \
  KC_TILD, _______, _______, _______, _______, _______, KC_TILD, _______, _______, KC_MINS,  KC_EQL, KC_DEL, \
  KC_GRV , _______, _______, _______, _______, _______, KC_GRV , _______, KC_UP  , _______, _______, _______, \
...
[_RAISE] = KEYMAP( \
  ...
  _______, _______, _______, _______, _______, _______, _______,   KC_P6,   KC_P5,   KC_P6, KC_PPLS, _______, \
 ...
 * |      |RGB Tg|RGB Md|      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |Hue Up|Hue Dn|      |      |      |      |mute  | Vol+ | Vol- |  F11 |  F12 |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |Sat Up|Sat Dn|      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |Val Up|Val Dn|      |      |             |      |      |      |      |      |
...
[_ADJUST] =  KEYMAP( \
  ...
  _______, RGB_HUD, RGB_HUI, _______, _______, _______, _______, KC_MUTE, KC_VOLU, KC_VOLD, KC_F11 , KC_F12 , \
